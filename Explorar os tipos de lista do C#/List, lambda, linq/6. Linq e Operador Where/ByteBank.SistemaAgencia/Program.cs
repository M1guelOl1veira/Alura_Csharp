...
namespace ByteBank.SistemaAgencia
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Sintaxe do método Where encadeado com OrderBy.
            //Isso é possível pq ambos retornam o tipo IEnumerable<T>.
            //Dentro dos argumentos contas é referenciada como conta.
